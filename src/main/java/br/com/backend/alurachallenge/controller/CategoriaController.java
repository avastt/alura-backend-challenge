...
public class CategoriaController {
	...
	public ResponseEntity<CategoriaDto> atualizarCategoria(@PathVariable Long id,
			@RequestBody @Valid AtualizaCategoriaForm atualizaCategoriaForm) {
	...
	public List<VideoDto> retornaVideosPorCategoria(@PathVariable Long id) {

		List<Video> videos = categoriaRepository.getVideosById(id);
